...
async function connectToWA() {
  console.log("Connecting HANSAYA-MD 🧬...");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      const up = `HANSAYA-MD connected ✅\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://github.com/HANSAYA-MD/HANSAYWA-MD/blob/main/images/DANUWA-MD.png?raw=true` },
        caption: up
      });
...
app.get("/", (req, res) => {
  res.send("Hey, HANSAYA-MD started✅");
});
